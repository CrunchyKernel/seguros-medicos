...
var consultaCotizaciones = consultaCotizaciones || {
...
;(function($, window, undefined){
    ...
    $.extend(consultaCotizaciones, {   
        ...
        actualizarTabla: function(estatus){
            oTable[estatus].draw(false);
        },
        crearTabla: function(estatus){
            oTable[estatus] = $('#listadoCotizaciones'+estatus).DataTable({
                ...
                "sAjaxSource": _root_+"cotizacion/getConsultaCotizaciones",
                "bServerSide": true,
                    ...
                    $.ajax({
                        ...
                        success: function(response)
                        {
                            if(response.status == 'success'){
                                consultaCotizaciones.actualizarTabla(estatus);
                            }
                            swal({
    ...
    $('body').delegate('.eliminarCotizacion', 'click', function(event){
        ...
        consultaCotizaciones.eliminarCotizacion(idCotizacion, estatus);
    });
