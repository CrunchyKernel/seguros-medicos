...
var conceptos2023 = conceptos2023 || {
        ...
        tabla: function(){
            oTable = $('#basicTable').DataTable({
                fnDrawCallback : function (oSettings) {
                	$(".campo").editable({
						url: _root_+"aseguradora/actualizaConceptos2023",
						sourceCache: false,
                ...
                "sAjaxSource": _root_+"aseguradora/getConceptos2023",
                "bServerSide": true,
