...
var consultaAseguradoras = consultaAseguradoras || {
...
;(function($, window, undefined){
    ...
    var form = $("#consultaAseguradoras");
    var oTable = null;
    
    $.extend(consultaAseguradoras, {   
        init: function(){
            this.tabla();
        },
        ...
        tabla: function(){
            oTable = $('#basicTable').DataTable({
                ...
                "sAjaxSource": _root_+"aseguradoras/getConsultaAseguradoras",
                "bServerSide": true,
    ...
    $('body').delegate('.actualizarTabla', 'click', function(event){
        ...
        consultaAseguradoras.actualizarTabla();
    });
})(jQuery, window);

jQuery(document).ready(function() {
    consultaAseguradoras.init();
});