				...
				function showHijos(){
					...
					if(hijos>1){
						for(var x=1;x<=hijos;x++){
							$("#hijos-container").append('<input type="text" name="edad-1-' + x + '" id="edad-1-' + x + '" class="form-control cotizador-nuevo" required>');
							$("#edad-1-" + x).mask("09");
							if(x<hijos){
								if(hijos-x==1)
						...
						$("#hijos-container").append('<input type="text" name="edad-1-1" id="edad-1-1" class="form-control cotizador-nuevo" required>');
