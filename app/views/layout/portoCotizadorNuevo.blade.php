						...
						<div class="col-md-10 offset-2">
							<div class="form-check">
								...
								<label class="form-check-label" for="multiregion">Quisiera cobertura en Estados de
									México más costosos (<a href="#" data-toggle="modal"
										data-target="#estados-modal">más información</a>)</label>
							</div>
						</div>
					</div>
					...
					<div class="form-group row d-none d-contacto">
						<div class="col-md-10 offset-md-2">
							<div class="form-check">
								...
								<label class="form-check-label" for="privacidad">Acepto los términos, condiciones y
					...
					<div class="form-group row d-none d-contacto">
						<div class="col text-center">
							<button type="submit"
								...
								id="next4">Muestrame la cotización</button>
						</div>
					</div>
