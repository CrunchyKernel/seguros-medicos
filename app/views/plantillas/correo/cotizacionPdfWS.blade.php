...
<body>
    ...
    {{($cotizacion::tablaDatosWS(false, false, true))}}
    <!--//URL::to('verCotizacion/'.$cotizacionDatos->id_cotizacion.'/'.$cotizacionDatos->secret)-->
    <p>Para m&aacute;s opciones de paquetes, precios y formas de pago da click <a href="{{$cotizacionDatos->dominio()->first()->dominio . $cotizacionDatos->dominio()->first()->ver_cotizacion . '/' . $cotizacionDatos->id_cotizacion . '/' . $cotizacionDatos->secret}}" target="_blank">aqu&iacute;</a></p>
