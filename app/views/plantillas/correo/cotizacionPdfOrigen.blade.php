...
<head>
    ...
    <title>{{ucwords(strtolower($cotizacionDatos->nombre))}} - Cotizacidon - Seguro de Gastos Mesdicos Mayores</title>
...
<body>
    ...
    {{($cotizacion::tablaDatos(false, false, true))}}
    <p>Para m&aacute;s opciones de paquetes, precios y formas de pago da click <a href="{{URL::to('verCotizacion/'.$cotizacionDatos->id_cotizacion.'/'.$cotizacionDatos->secret)}}" target="_blank">aqu&iacute;</a></p>
