...
<div class="row">
    <div class="col-md-12">
    	<form id="altaEmailBlackForm" name="altaEmailBlackForm">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h4 class="panel-title">Lista negra</h4>
                ...
                <div class="panel-body">
                    <div class="row">
                        ...
                        <div class="col-sm-2">
                        	 <button class="btn btn-primary agregarEmailBlack" type="submit" data-loading-text='Procesando {{HTML::image('assets/img/ajax-loader.gif')}}'><i class="fa fa-save"></i> Guardar</button>
                        </div>
                    </div>
                </div>
            </div>
