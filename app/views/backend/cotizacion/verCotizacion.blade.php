            ...
            <div class="row">
                <div class="col-sm-6">
                    ...
                    <address>
                        ...
                        @endif
                      	<strong>Whatsapp:</strong> <a href="https://wa.me/521{{$cotizacionDatos->telefono}}?text=Hola {{$cotizacionDatos->nombre}}" target="_blank"><i class="fa fa-whatsapp"></i></a>
            ...
            <div class="table-responsive">
                ...
                @if(strlen($cotizacionDatos->comentarios) > 0)
                    ...
                    <div class="alert alert-info fade in nomargin">
                        ...
                        <p>{{$cotizacionDatos->comentarios}}</p>
                    </div>
                @endif
                <br>
                <!-- Nav tabs -->
                <ul class="nav nav-tabs nav-info">
                    <li class="active"><a href="#cotizacion_dasa" data-toggle="tab"><strong>SA-DA</strong></a></li>
                    ...
                    <li class=""><a href="#cotizacion_editar" data-toggle="tab"><strong>Editar</strong></a></li>
                </ul>
