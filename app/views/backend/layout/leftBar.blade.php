<div class="leftpanel">
    <div class="media profile-left">
        <a class="pull-left profile-thumb" href="profile.html">
            {{HTML::image('backend/images/avatars/default.png', '', array('class' => 'img-circle'))}}
        </a>
        <div class="media-body">
            <h4 class="media-heading">{{Auth::user()->nombre}} {{Auth::user()->apellido_paterno}}</h4>
            <!--<small class="text-muted">{{Auth::user()->puesto}}</small><br>-->
            <small class="text-muted"><a href="{{URL::to('/admingm/login/cerrarSesion')}}">Cerrar sesión</a></small>
        </div>
    </div><!-- media -->
    ...
    <ul class="nav nav-pills nav-stacked">
        ...
        <!--
        <li>
            <a href="index-2.html"><i class="fa fa-home"></i> <span>Cotizaciones</span></a>
        </li>
