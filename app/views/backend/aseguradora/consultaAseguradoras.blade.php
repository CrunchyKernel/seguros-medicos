        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h4 class="panel-title">Aseguradoras</h4>
                    <p>Listado con las aseguradoras del sistema</p>
                    <a href="{{URL::to('admingm/aseguradoras/altaAseguradora')}}"><i class="fa fa-plus-circle"></i> Nueva aseguradora</a>
                    ...
                    <table id="basicTable" class="table table-striped table-bordered table-hover responsive">
                        <thead>
                            <tr>
                                ...
                                <th class="alignCenter">Configuracion</th>
